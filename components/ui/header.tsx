diff --git a//dev/null b/components/header.tsx
index 0000000000000000000000000000000000000000..c25e6acdce1e1da64ea0f141c5a5c4bda8146de1 100644
--- a//dev/null
...
+        active === link.id ? "text-primary font-medium" : ""
+      }`}
+    >
+      {link.label}
+    </a>
